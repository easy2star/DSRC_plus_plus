...
from opencood.weather_trans.beam_missing import apply_beam_missing_to_numpy
from opencood.weather_trans.motion_blur import apply_motion_blur_to_numpy
from opencood.weather_trans.fog.fog_simulation import apply_fog_to_numpy
from opencood.weather_trans.cross_talk import apply_cross_talk_to_numpy
from opencood.weather_trans.cross_sensor import apply_cross_sensor_to_numpy
...
class BaseDataset(Dataset):
    ...
    def retrieve_base_data(self, idx, cur_ego_pose_flag=True):
        ...
        for cav_id, cav_content in scenario_database.items():
            ...
            # data[cav_id]['lidar_np'] = apply_beam_missing_to_numpy(data[cav_id]['lidar_np'])
            # data[cav_id]['lidar_np'] = apply_motion_blur_to_numpy(data[cav_id]['lidar_np'])
            # data[cav_id]['lidar_np'] = apply_fog_to_numpy(data[cav_id]['lidar_np'])
            # data[cav_id]['lidar_np'] = apply_cross_talk_to_numpy(data[cav_id]['lidar_np'])
            # data[cav_id]['lidar_np'] = apply_cross_sensor_to_numpy(data[cav_id]['lidar_np'])
