...
class IntermediateFusionDataset(basedataset.BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        for cav_id, selected_cav_base in base_data_dict.items():
            ...
            early_fusion_lidar_stack.append(selected_cav_processed['projected_lidar'])
    ...
    def collate_batch_train(self, batch):
        ...
        early_fusion_merged_feature_dict = self.merge_features_to_dict(early_fusion_processed_lidar_list)
        ...
        merged_feature_paint_dict = self.merge_features_to_dict(processed_lidar_paint_list)
